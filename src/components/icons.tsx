...
export const Flower = ({ size = ICON_SIZE.md, isFilled = false, className, style }: SelectableProps) => {
  ...
  return (
    <svg {...stroke(size, className, style)}>
      {/* Прорези между пальцами — настоящий вырез маской, а не закраска
          цветом подложки: под панелью не всегда `--surface`. Без них залитая
          ладонь выбранной вкладки превращалась в сплошное пятно — насечки по
          верхнему краю в 25 px заливка съедает. */}
      {isFilled && (
        <mask id={cut} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
          <rect x="0" y="0" width="24" height="24" fill="white" />
          <path
            d="M14.8 7.4v5.4M12.2 5.6v7.2M9.6 7.0v5.8"
            stroke="black" strokeWidth={1.05} strokeLinecap="round"
          />
        </mask>
      )}
      <g transform="translate(12 12) scale(0.9) translate(-12 -12)">
        <path
          d="M16.1 13.1V7.4a1.3 1.3 0 0 0-2.6 0v5.0V5.3a1.3 1.3 0 0 0-2.6 0v7.1V6.8a1.3 1.3 0 0 0-2.6 0v7.6l-1.3-1.9a1.4 1.4 0 0 0-2.3 1.6l2.7 4.1a5 5 0 0 0 4.2 2.2h1a5 5 0 0 0 5-5v-3.5a1.3 1.3 0 0 0-2.6 0v1.2z"
          fill={isFilled ? 'currentColor' : 'none'}
          mask={isFilled ? `url(#${cut})` : undefined}
        />
        <path d="M18.9 3.1l.55 1.45 1.45.55-1.45.55-.55 1.45-.55-1.45-1.45-.55 1.45-.55z"
